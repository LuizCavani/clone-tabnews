  ...
  describe("Default User", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "e1bbec1aa995767ff168c71b9f6b0589de050759287bc6be6c893dd413a73ac2b756cd2b8386658ad26c28b4b2e16d49";
    ...
    test("With an almost expired session", async () => {
      const fifteenDaysInMilliseconds = session.EXPIRATION_IN_MILLISECONDS / 2;

      jest.useFakeTimers({
        now: new Date(Date.now() - fifteenDaysInMilliseconds),
      });
